        ...
        <div className="bg-white/60 dark:bg-[var(--color-bg-card)]/80 backdrop-blur-2xl rounded-2xl border border-[var(--color-border)] shadow-[var(--shadow-soft)] p-8">
          ...
          <p className="text-center mt-4 text-xs text-[var(--color-text-tertiary)]">
            ...
            <button
              ...
              className="text-[var(--color-gold)] font-medium hover:underline cursor-pointer"
            >
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              disabled={loading}
              className="w-full py-3 rounded-xl text-sm font-medium text-[var(--color-text-primary)] border border-[var(--color-border)] hover:border-[var(--color-border-gold)] bg-[var(--color-bg-input)] hover:bg-[var(--color-gold-dim)] transition-all flex items-center justify-center gap-3 cursor-pointer group hover:shadow-[var(--shadow-soft)]"
            >
